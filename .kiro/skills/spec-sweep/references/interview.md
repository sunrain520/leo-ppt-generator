...
After the interview completes, merge these flat keys into `<repo-root>/.spec-first/config.local.yaml`, preserving any unrelated keys already present.
